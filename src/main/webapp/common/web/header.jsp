					...
					<div class="col-xl-12">
						<div class="row d-flex justify-content-between align-items-center">
							<div class="header-info-left">
								<ul>
									<li><img
										src='<c:url value="/template/web/assets/img/icon/header_icon1.png"/>'
										alt="">34ºc, Sunny</li>
									<li><img
										src="<c:url value="/template/web/assets/img/icon/header_icon1.png"/>"
					...
					<div class="row d-flex align-items-center">
						...
						<div class="col-xl-3 col-lg-3 col-md-3">
							<div class="logo">
								<a href="index.html"><img
									src='<c:url value="/template/web/assets/img/logo/logo.png"/>'
									alt=""></a>
							</div>
						</div>
						<div class="col-xl-9 col-lg-9 col-md-9">
							<div class="header-banner f-right ">
								<img
									src='<c:url value="/template/web/assets/img/hero/header_card.jpg"/>'
									alt="">
							</div>
						</div>
					</div>
